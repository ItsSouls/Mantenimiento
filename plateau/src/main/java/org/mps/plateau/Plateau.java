...
import org.mps.coverage.ExcludeGeneratedCodeFromCoverage;
...
public class Plateau {
    ...
    public static Pair longestPlateau(int[] xs) {
        if (xs == null || xs.length < 3) {
            ...
            System.out.println("Primer If"); // para comprobar fácilmente la cobertura de ramas
        }
        ...
        while (i < xs.length - 2) {
            ...
            if (i < xs.length - 2) {
                ...
                if (i < xs.length - 1 && xs[i] > xs[i + 1] && i - currentPos + 1 > longestLength) {
                    ...
                    System.out.println("Segundo If"); // para comprobar fácilmente la cobertura de ramas
                }
            }else{
                System.out.println("Tercero If"); // para comprobar fácilmente la cobertura de ramas
            }
        }
